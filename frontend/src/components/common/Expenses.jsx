...
const Expense = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 bg-expenseBC ">
      <div >
        <div className="px-16 pt-10">
          {/* {<BackButton href={"/controller/volunteering"} header={"Back"} />} */}
        </div>
        <div className="px-5 ">
          <form className="bg-red-50 border-[3px] border-golden shadow-lg rounded-[20px] m-10 text-gray-900  font-semibold text-base">
            <div className="flex flex-col p-5 ">
                <div className=" flex w-full h-80 shadow-md justify-end rounded-t-[20px] opacity-90 items-end bg-credit-card bg-cover bg-center">
                    <h1 className="flex shadow-md bg-expenseBC font-bold px-5 py-3 w-full ">
      ...
      <div className=" bg-white rounded-l-[50px]">
